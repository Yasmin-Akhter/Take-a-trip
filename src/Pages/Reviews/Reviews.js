...
const Reviews = () => {
    const reviews = [
        ...
        {
            id: 2, name: "Shovon S R", description: "Thank you for our lovely tour of Sibiu and Alba Iulia! It was grate, you were grate. The tour and information were exceptional"
        },
        {
